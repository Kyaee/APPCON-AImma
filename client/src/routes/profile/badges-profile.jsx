...
export default function BadgesProfile({ badgesData }) {
  ...
  const [allBadges] = useState(badgesData || [
    {
      id: 1,
      name: "Welcome badge",
    ...
    <section className="overflow-hidden">
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <h3 className="font-medium text-lg mt-4 mb-2">Earned Badges ({earnedBadges.length})</h3>
                ...
                <h3 className="font-medium text-lg mt-6 mb-2">Badges to Earn ({unearnedBadges.length})</h3>
                <div className="grid grid-cols-5 gap-3">
      ...
      <div className="bg-background dark:bg-dark-mode-bg p-5 rounded-lg border-2 border-foreground overflow-hidden">
        <div className="flex items-center gap-3 py-1 pb-3 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent pr-3 pl-3 whitespace-nowrap">
          ...
          {unearnedBadges.map((badge) => (
            <div key={badge.id} className="group transition opacity-100 flex-shrink-0">
              <img
                src={badge.image}
        ...
        <p className="pl-3 text-sm text-black dark:text-primary mt-1">
          Complete more lessons to gain badges! ({earnedBadges.length}/{allBadges.length} earned)
        </p>
      </div>
    </section>
  );
