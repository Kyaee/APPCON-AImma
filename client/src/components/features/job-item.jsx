...
const OpportunitiesMenu = ({
  ...
  return (
    <div className="relative w-full h-full rounded-lg border-2 border-foreground dark:border-dark-mode-highlight bg-card dark:bg-dark-mode-bg custom-shadow-50 p-6">
      ...
      <div className="absolute bottom-6 left-6 right-6 flex justify-between">
        <button className="w-[172px] h-[39px] rounded-lg border border-primary bg-background dark:bg-dark-mode-bg flex items-center gap-2 justify-center">
          <X className="size-5" />
