...
export default function NetworkingQuestionsStep({ answers, onAnswerChange }) {
  const questions = assessmentFlow.networkingQuestions.questions || [];

  return (
    <div className="mt-8 border-t border-white/30 pt-6">
      <h3 className="text-2xl font-bold text-white mb-4">
        {assessmentFlow.networkingQuestions.title}
      </h3>
